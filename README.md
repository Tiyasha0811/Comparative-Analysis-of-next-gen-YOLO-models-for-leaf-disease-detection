...
We introduce novel metrics tailored for ornamental plant pathology:
...
Extensive data augmentation (flip, rotation, brightness, mosaic, mix-up)
...
Benchmarking future YOLO architectures on non-crop datasets
...
Extend OrnaFoliage with multispectral imagery

Edge-device deployment (Jetson / mobile inference)

Evaluation of future YOLO versions and transformer-based detectors
